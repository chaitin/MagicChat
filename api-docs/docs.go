...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/admin.assistantSettingsResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.updateAssistantSettingsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "admin.assistantSettingsResponse": {
            "type": "object",
            "properties": {
                "auto_group_naming_enabled": {
                    "type": "boolean",
                    "example": true
                },
                "auto_group_naming_message_count": {
                    "type": "integer",
                    "example": 5
                }
            }
        ...
        "admin.updateAssistantSettingsRequest": {
            "type": "object",
            "properties": {
                "auto_group_naming_enabled": {
                    "type": "boolean"
