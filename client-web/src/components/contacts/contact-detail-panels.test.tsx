...
describe("AppDetailPanel", () => {
  ...
  it("renders the owned application actions and opens its developer profile", async () => {
    ...
    expect(accessInfoButton.parentElement).toHaveClass("grid")
    expect(accessInfoButton.parentElement).not.toHaveClass("grid-cols-2")
    expect(accessInfoButton.querySelector("svg")).toBeNull()
    expect(editProfileButton.querySelector("svg")).toBeNull()
